...
probabilidadeSangueNome(Pai, Mae, Fenotipo, Destino, Percentual):-
...
probabilidadeSangueTodos(Pai, Mae, Destino, Lista):-
	consultaPessoa(Pai, Destino, [Gene1|_]), consultaPessoa(Mae, Destino, [Gene2|_]),
...
probabilidadeCalvicieNome(Pai, Mae, Fenotipo, Destino, Percentual):-
...
probabilidadeCalvicieTodos(Pai, Mae, Destino, Lista):-
	consultaPessoa(Pai, Destino, [_,[G1,G2,_]|_]), consultaPessoa(Mae, Destino, [_,[G3,G4,_]|_]),
...
probabilidadeOlhoNome(Pai, Mae, Fenotipo, Destino, Percentual):-
...
probabilidadeOlhoTodos(Pai, Mae, Destino, Lista):-
	consultaPessoa(Pai, Destino, [_,_,[O1,O2,O3,O4],_]), consultaPessoa(Mae, Destino, [_,_,[O5,O6,O7,O8],_]),
...
probabilidadePeleNome(Pai, Mae, Fenotipo, Destino, Percentual):-
...
probabilidadePeleTodos(Pai, Mae, Destino, Lista):-
	consultaPessoa(Pai, Destino, [_,_,_,[P1,P2,P3,P4]]), consultaPessoa(Mae, Destino, [_,_,_,[P5,P6,P7,P8]]),
...
inserirPessoa(pessoa(Nome, _), Destino):- consult(Destino), pessoa(Nome, _) , write('Nome já cadastrado!'), !, fail.
inserirPessoa(Pessoa, Destino):-append(Destino), write(Pessoa), write('.'), write('\n'), told.
consultaPessoa(Nome, Destino, Genes):- consult(Destino), pessoa(Nome, Genes).
